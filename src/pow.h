...
/** Doichain: number of blocks from DoiDifficultyHeight that use the fixed reset
 *  target (nDoiDifficultyResetBits) before DigiShield averaging takes over. */
int DigishieldResetWindow(const Consensus::Params&);
