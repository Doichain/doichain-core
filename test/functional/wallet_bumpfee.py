...
def test_no_more_inputs_fails(self, rbf_node, dest_address):
    ...
    assert_raises_rpc_error(-4, "Unable to create transaction. The total exceeds your balance when the 0.00005041 transaction fee is included.", rbf_node.bumpfee, rbfid)
    self.clear_mempool()
