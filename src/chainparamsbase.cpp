...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-digishieldresetbits=<hex>", "Compact target (nBits, hex) used for the DigiShield reset window at -digishieldheight; unset = no reset. (regtest-only)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
